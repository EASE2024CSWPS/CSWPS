...
class RNNEncoder(EncoderBase):
    ...
    def forward(self, emb, lengths=None):
        ...
        if lengths is not None:
            ...
            packed_emb = pack(
                packed_emb[indices], lengths.tolist(), batch_first=True
            )
        ...
        for i in range(self.nlayers):
            if i != 0:
                ...
                if lengths is not None:
                    packed_emb = pack(
                        packed_emb, lengths.tolist(), batch_first=True
                    )
            ...
            packed_emb = (
                unpack(packed_emb, batch_first=True)[0]
                if lengths is not None
                else packed_emb
            )
